/*
  # Fix Offer Notification Trigger to Get Agent from Property

  1. Changes
    - Update the notify_agent_of_new_offer function to get the agent_id from the properties table
    - The property_offers table doesn't have agent_id, so we need to join through the property
