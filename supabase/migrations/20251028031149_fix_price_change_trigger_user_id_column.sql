/*
  # Fix Price Change Notification Trigger - User ID Column

  1. Changes
    - Update trigger to use correct column name: user_id instead of buyer_id
    - Favorites table uses user_id, not buyer_id
