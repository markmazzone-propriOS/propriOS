/*
  # Fix Appointment Calendar Sync Phone Column Name
  
  1. Changes
    - Update sync function to use phone_number instead of phone
    - Profiles table uses phone_number, not phone
  
  2. Notes
    - Corrects column name reference in the trigger function
*/
