/*
  # Update Email Notification for New Listing Type

  ## Overview
  Updates the email notification trigger to send different emails based on notification_type:
  - new_listing: "New property available to claim"
  - buyer_viewed: "A buyer is interested in this property"

  ## Changes
  - Update trigger function to check notification_type
  - Send appropriate email content based on type
  - Handle null buyer_id for new_listing type
*/
