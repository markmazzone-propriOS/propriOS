/*
  # Fix Renter Journey Trigger Table Name

  ## Overview
  Updates the trigger function to use the correct table name: renter_journey_progress
  instead of renter_journeys.

  ## Changes
  - Fix update_renter_journey_from_application() to reference correct table
*/

-- Fix the trigger to use correct table name
...
BEGIN
  ...
  -- Update or create renter journey using correct table name
