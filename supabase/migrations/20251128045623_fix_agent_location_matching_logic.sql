/*
  # Fix Agent Location Matching

  ## Overview
  Agents have locations stored as city names (e.g., "Havelock"), but the function
  was looking for "City, State" format. This fixes the matching to work with the
  actual data format.

  ## Changes
  - Check if agent's locations array contains the property's city
  - Also check for state matches
