...
export function SellerJourneyTracker() {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-white rounded-lg shadow-md p-6 mb-8">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Your Selling Journey</h2>
          <p className="text-gray-600">Track your progress from preparation to closing</p>
        </div>
        <button
      ...
      {progress.current_stage === 'completed' && (
        <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg text-center">
          <p className="text-green-800 font-semibold">Congratulations! Your property sale is complete!</p>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6">
              This will reset all your progress and start your selling journey from the beginning.
